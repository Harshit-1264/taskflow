...
const API_URL = "https://taskflow-backend-a9c7.onrender.com";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto p-6">
        <button onClick={() => navigate(-1)} className={BACK_BUTTON}>
          <ChevronLeft className=" m-5 h-5 mr-1" />
          Back to Dashboard
        </button>

        <div className="flex items-center gap-4 mb-8">
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-fuchsia-500 to-purple-600 flex text-center justify-center text-white text-2xl font-bold shadow-md">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <section className={SECTION_WRAPPER}>
            ...
            <form onSubmit={changePassword} className="space-y-4">
                ...
                <button className={FULL_BUTTON}>
                <Shield className=" w-4 h-4" /> Changes Password
              </button>
