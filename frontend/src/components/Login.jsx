...
const Login = ({onSubmit, onSwitchMode}) => {
  ...
  const url = "https://taskflow-backend-a9c7.onrender.com";
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button type="submit" className={BUTTON_CLASSES} disabled={loading}>
          ...
          <p className=" text-center text-sm text-gray-600 mt-6">
            ...
            <button type="button" className="text-purple-600 hover:text-purple-600 hover:underline font-medium transition-colors" onClick={handleSwitchMode}>Sign Up</button>
          </p>
