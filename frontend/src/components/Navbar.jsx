...
const Navbar = ({user={}, onLogout}) => {
  ...
  return (
    <header className=' sticky top-0 z-50 bg-white/90 blackdrop-blur-md shadow-sm border-b border-gray-200 font-sans '>
            ...
            <div ref={menuref} className='relative'>
                <button onClick={handleMenuToggle} className='flex items-center gap-2 px-3 py-2 rounded-full cursor-pointer hover:bg-purple-50 transition-colors duration-300 border-transparent hover:border-purple-200'>
                    ...
                    <div className='text-left hidden md:block'>
                        ...
                        <p className='text-xs text-gray-800 font-normal'>{user.email}</p>
                    </div>
