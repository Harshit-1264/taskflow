...
const Layout = ({ onLogout, user }) => {  
  ...
  const fetchTasks = useCallback(async () => {
    ...
    try{
      ...
      const {data} = await axios.get("https://taskflow-backend-a9c7.onrender.com/api/tasks/gp", {
      ...
      <div className=" ml-0 xl:ml-64 lg:ml-64 md:ml-16 pt-16 p-3 sm:p-4 md:p-4 transition-all duration-300 ">
        <div className=" grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="xl:col-span-1 space-y-4 sm:space-y-6">
            <div className="bg-white-6 rounded-xl p-4 sm:p-5 shadow-sm border border-perple-100">
                ...
                <div className=" relative pt-1 ">
                  <div className=" flex gap-1.5 items-center">
                    <div className=" flex-1 h-2 sm:h-3 bg-purple-100 rounded-full overflow-hidden">
                      <div className=" h-full bg-gradient-to-r from-fuchsia-500 to-purple-600 transition-all duration-100"
            ...
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100">
              ...
              <div className="space-y-2 sm:space-y-3">
                {tasks.slice(0,3).map((task) => (
                  <div key={task._id || task.id} className="flex items-center justify-between p-2 sm:p-3 hover:bg-purple-50/50 rounded-lg transition-colors duration-200 border border-transparent hover:border-pink-100">
                ...
                {tasks.length === 0 && (
                  <div className="text-center py-4 sm:py-6 px-2">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto sm:mb-4 rounded-full bg-purple-100 flex items-center justify-center">
                      <Clock className=" w-6 h-6 sm:w-8 sm:s-8 text-purple-500" />
                    </div>
